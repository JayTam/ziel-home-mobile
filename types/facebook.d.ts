...
interface IFacebook {
  ...
  ui(params?: IFacebookUIParameters, cb?: (response?: any) => void): void;

  login(cb?: (response: IFacebookUserAuthenticate) => any, opts?: { scope: string }): void;
